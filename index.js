...
function get20s(array) {
  ...
  for (let i = 0; i < array.length; i++){
    if (parseInt(array[i].years.split(' - '),10) > 1900){
...
function addArtist(array) {
  array.push({id: 20, name: 'Eli Kirschbaum', years: '1993-2021', genre: 'Web Design', nationality: 'American', bio: "Lorizzle the bizzle dolor own yo' amet, sure adipiscing stuff. Yippiyo fizzle velizzle, sheezy volutpizzle, suscipizzle quis, gravida vel, tellivizzle. "});
  return array;
}
